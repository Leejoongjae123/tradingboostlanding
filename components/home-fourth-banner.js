...
export default function HomeFourthBanner({ className = "" }) {
  return (
    <section
      className={`w-full bg-grayscale-grayscale-1000 overflow-hidden flex flex-col items-center justify-center py-[120px] px-[10vw] box-border gap-[54px] max-w-full text-center text-13xl text-deeppink-100 font-pretendard  ${className}`}
    >
      <SlideRight>
        <div
          class="relative w-[90vw] md:w-full"
          tabindex="-1"
            ...
            >
              <li class="w-full" uk-scrollspy-class="uk-animation-fade">
                <div class="card w-full h-full box-border">
                  <div className="rounded-2xl bg-gray-200 border-thistle-100 border-[1px] border-solid box-border flex flex-col items-center justify-center py-12 w-full h-full px-8 md:px-20">
                    <div className="flex flex-col items-center justify-start gap-6 w-full h-full px-6">
                      <div className="w-full text-2xl h-full text-white font-medium">
                        <b className="text-deeppink-100">하이퍼 RSI DCA</b>의
                    ...
                    <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-10 my-12">
                      ...
                      <div className="col-span-1">
                        <div className="text-xl md:text-2xl font-bold text-white text-left">
                          과매도,과매수에만 진입할 수 있어요!
                        </div>
                        <div className="text-xs md:text-base text-white text-left mt-5 ">
                          <p className="m-0">
                      ...
                      <div className="md:hidden col-span-1 flex justify-start items-center">
                        <img
                          className="h-auto w-full object-cover "
                          loading="lazy"
                          alt=""
                      ...
                      <div className="hidden md:block col-span-1 justify-start items-center">
                        <img
                          className="h-auto w-full object-cover "
                          loading="lazy"
                          alt=""
                      ...
                      <div className="col-span-1">
                        ...
                        <div className="text-xs md:text-base text-white text-left mt-5 ">
                          ...
                          <p className="m-0">
                            반대 포지션을 진입하게 하여, 한 방향으로 폭등하거나
                            폭락하는 것에 대한 손실을 예방할 수 있습니다.{" "}
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="flex flex-row items-center justify-center">
                      <div className="flex items-center justify-center w-full">
                        <button className="flex items-center justify-center bg-deeppink-100 text-white font-bold py-1 px-4 rounded-lg hover:bg-deeppink-200 hover:text-deeppink-100 transition duration-300 cursor-pointer">
              ...
              <li class="w-full" uk-scrollspy-class="uk-animation-fade">
                <div class="card w-full h-full box-border">
                  <div className="rounded-2xl bg-gray-200 border-thistle-100 border-[1px] border-solid box-border flex flex-col items-center justify-center py-12 w-full h-full px-8 md:px-20">
                    <div className="flex flex-col items-center justify-start gap-6 w-full h-full px-6">
                      <div className="w-full text-2xl h-full text-white font-medium">
                        <b className="text-deeppink-100">
                          부스터 그리드(Booster Grid)
                        </b>
                        의
                        <br className="md:hidden" />
                        <b> </b>장점을 소개할게요.
